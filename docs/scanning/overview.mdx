...
For scanning multiple panes at the same station in one request, use the batch endpoint (full contract: [Batch scan panes](/api-reference/scanning/batch-scan-panes)):
